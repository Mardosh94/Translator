...
namespace AI_Translator
{
    public partial class mainForm : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            TextToSpeech speak = new TextToSpeech(outputBox.Text, toLanguageList.SelectedIndex);
        }
        ...
        private void toLanguageList_SelectedIndexChanged(object sender, EventArgs e)
        {
